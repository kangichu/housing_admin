    ...
    init: function() {
        ...
        !function() {
            ...
            function o(e, t, a) {
                ...
                s = e.format("MMM D")) : "Yesterday" == a ? (o = "Yesterday:",
                s = e.format("MMM D")) : s = e.format("MMM D") + " - " + t.format("MMM D"),
            ...
            success: function(response) 
            {
                if(response.status == 200)
                    a && new ApexCharts(a,{
                        series: [{
                            name: "Views",
                            data: response.viewsByMonth
                        }, {
                            name: "Requests",
                            data: response.schedulesByMonth
                        }],
                        chart: {
                            fontFamily: "inherit",
                            type: "bar",
        ...
        function() {
            var e, t, a, o = document.querySelectorAll(".mixed-widget-2-chart"), s = KTUtil.getCssVariableValue("--bs-gray-500"), r = KTUtil.getCssVariableValue("--bs-gray-200");
        ...
        function() {
            var e, t, a, o = document.querySelectorAll(".mixed-widget-10-chart"), s = KTUtil.getCssVariableValue("--bs-gray-500"), r = KTUtil.getCssVariableValue("--bs-gray-200"), i = KTUtil.getCssVariableValue("--bs-gray-300");
            [].slice.call(o).map((function(o) {
