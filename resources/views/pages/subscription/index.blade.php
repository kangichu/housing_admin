		...
		<div class="row row-cols-1 row-cols-md-2 row-cols-xl-3 g-5 g-xl-9">
			...
			@if(count($subscriptions) > 0)
				@foreach($subscriptions as $key=>$subscription)
							...
							<div class="card-body pt-4">
								...
								<div class="ms-1" style="position: relative; float: right;">
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3" data-kt-menu="true" style="">
										...
										<!--begin::Menu item-->
										<div class="menu-item px-3">
											<a href="#" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#feautures-{{$subscription->id}}">Outline Features</a>
										</div>
										<!--end::Menu item-->
										<!--begin::Menu item-->
										<div class="menu-item px-3">
											<a href="#" class="menu-link flex-stack px-3">Outline Limitations
								...
								<!--begin::Desc-->
								<p class="mb-4">{{ Str::words($subscription->description, 30, '.......') }}</p>
					...
					<div class="modal fade" tabindex="-1" id="feautures-{{$subscription->id}}">
